...
int main(int argc, char* argv[]) {
#ifdef _WIN32
  const char dll_name[]("LCMake_test_lib_06_shared_library_class_classic" LCMAKE_CONFIG_POSTFIX ".dll");
  ...
  FreeLibrary(dll);
#else
  const char so_name[]("./" "lib" "LCMake_test_lib_06_shared_library_class_classic" LCMAKE_CONFIG_POSTFIX ".so");
